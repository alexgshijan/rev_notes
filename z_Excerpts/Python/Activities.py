    ...
    # if we did open it then let's carry on!
        ...
        while True:
            ...
            if typeSave in recordVar[0:30] and not typeSave=="" :
                CountGot +=1
            if # . . . in recordVar[30:35] and not sessionSave=="" :
                CountGot +=1
            if # . . . in recordVar[35:45] and not daySave=="":
                CountGot +=1
            if # . . . in recordVar[45:75] and not locationSave =="":
                CountGot +=1
            if # . . . in recordVar[75:90] and not levelSave=="":
                CountGot +=1
            if CountGot == CountNeeded:
                SessionCount +=1
                
        messagebox.showinfo("Information",str(# . . .) + " Sessions have been found! Contact the centre for more information.")    
